...
//       <Text style={{ color: 'red', fontSize: 28, fontWeight: '900', textAlign: 'center' }}>Babel {HotUpdater.getBundleId()}</Text>
...
//     `${Config.HOT_UPDATER_SUPABASE_URL}/functions/v1/update-server`,
//     {
